...
import com.lzp.zprpc.registry.redis.util.RedisClientFactory;
...
public class RedisClient implements RegistryClient {
    ...
    com.lzp.zprpc.registry.redis.api.RedisClient redisClient = RedisClientFactory.newRedisClient(HOST);
     ...
     */
    public Map<String, Object> searchAndRegiInstance(String basePack, String ip, int port) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public void deregiServices(Set<String> serivces, String ip, int port) {
    ...
    private void regiInstanceIfNecessary(com.lzp.zprpc.registry.redis.api.RedisClient redisClient, String ip, int port, Map<String, Object> idServiceMap, Class cls) throws InstantiationException, IllegalAccessException {
